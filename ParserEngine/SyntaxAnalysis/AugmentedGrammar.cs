namespace ParserEngine.SyntaxAnalysis
{
    public class AugmentedGrammar : Grammar
    {
		...
		public Production InitialProduction { get { return this[INITAL_SYMBOL_ID]; } }
		...
		public override void Add(Production item)
        {
            ...
            {
				var initialProduction = new Production(new NonTerminal(INITAL_SYMBOL_NAME), item.Symbol, null) { ID = INITAL_SYMBOL_ID };
